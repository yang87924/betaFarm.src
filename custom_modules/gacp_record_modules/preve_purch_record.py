...
PREVE_PURCH_RECORD = Blueprint('PREVE_PURCH_RECORD', __name__)

@PREVE_PURCH_RECORD.route('/api/PREVE_PURCH_RECORD', methods=['POST', 'PUT'])
@required_login
@trace_sys_flag_check
def api_PREVE_PURCH_RECORD():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            g.session.add(db.models.PREVE_PURCH_RECORD(
                farm_id=farm_id,
                region_id=region_id,
        ...
        if farm_active:
            for id in farm_active:
                farm_id += str(id[0])
        record = (g.session
                   .query(db.models.PREVE_PURCH_RECORD)
                   .filter(db.models.PREVE_PURCH_RECORD.record_id == record_id)
        ...
        max_old_counter = (g.session
                            .query(db.models.PREVE_PURCH_RECORD)
                            .filter(db.models.PREVE_PURCH_RECORD.record_id == record_id)
                            .order_by(db.models.PREVE_PURCH_RECORD.is_old.desc())
                            .first())
